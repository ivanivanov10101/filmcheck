  ...
  return (
    <div className="movie-info">
      <div className="news-title-block">
        <div className="header__contents__text__child__movie-page news-title-height">
          {details.name}
        </div>
        <div className="news__author">
          Author:{" "}
          <div className="stats MovieInfoImportDataColor">{details.author}</div>
        </div>
        <div className="news__author">
          Date:{" "}
          <div className="stats MovieInfoImportDataColor">{details.date}</div>
        </div>
      </div>
